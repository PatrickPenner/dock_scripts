...
class AnchoredGrowingTest(TestCase):
    """Test anchored growing"""
    ...
    def test_run(self):
        ...
        protein = os.path.join(BASE_DIR, 'tests', 'test_files', '3ryx_clean.pdb')
        native_ligand = os.path.join(BASE_DIR, 'tests', 'test_files', '3ryx_ligand.mol2')
